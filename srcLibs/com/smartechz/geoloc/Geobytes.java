...
import com.smartechz.geoloc.JavUtil;
import com.smartechz.geoloc.HTTPRequest;
...
public class Geobytes {
	...
	public static void refresh() {
		try {
			String urlStr = "http://gd.geobytes.com/gd?after=-1&variables=Geobytes";
			ArrayList<String> fVals = JavUtil.getFieldsValues(Geobytes.class, String.class, 25);

			for (int f = 0; f < fVals.size(); f++) {
				urlStr += URLEncoder.encode(",Geobytes" + fVals.get(f), "UTF-8");
			}
